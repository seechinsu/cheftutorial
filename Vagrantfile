...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "seechinsu-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/seechinsu"
  #   chef.validation_client_name = "seechinsu-validator"
  #   chef.validation_key_path = ".chef/seechinsu-validator.pem"
  # end
end
